...
import { ChevronDown, ArrowDownAZ, ArrowUpZA, Clock, Banknote, Percent, Plus } from "lucide-react";
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative p-8">
        ...
        <div className="flex flex-col items-center justify-center gap-8 relative z-10">
          {/* Launch Token Button */}
          <section className="flex flex-col items-center gap-4 w-full max-w-4xl mb-6">
            <Link href="/launch">
              <Button 
                variant="outline" 
                size="lg"
            ...
            <div className="flex flex-col items-center gap-4"> create a token in &lt;2 mins and &lt; $2 </div>
          </section>
          ...
          {/* Include the styles for cards and animations */}
          <style jsx global>{`
            /* Cyber card styling */
            .cyber-card {
            ...
            @keyframes card-shake {
              ...
              20% { transform: translate(-4.5px, 2.5px); }
              40% { transform: translate(-2.5px, -2.5px); }
              60% { transform: translate(4.5px, 2.5px); }
              80% { transform: translate(2.5px, -4.5px); }
