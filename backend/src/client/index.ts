...
console.log("envFEES_WALLET_SECRET_KEY", process.env.FEES_WALLET_SECRET_KEY);
...
// @ts-ignore
export const keyPair = Keypair.fromSecretKey(bs58.decode(process.env.FEES_WALLET_SECRET_KEY));
