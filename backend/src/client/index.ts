...
console.log("envFEES_WALLET_SECRET_KEY", process.env.envFEES_WALLET_SECRET_KEY);
...
// @ts-ignore
export const keyPair = Keypair.fromSecretKey(bs58.decode(process.env.envFEES_WALLET_SECRET_KEY));
